  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        <h2 style={styles.title}>🎥 Interview Session</h2>
        <p style={styles.subtitle}>Webcam, mic, and AI bot will appear here.</p>
        <button style={styles.btn} onClick={() => navigate('/setup')}>← Back to Setup</button>
      </div>
    </div>
  )
}
